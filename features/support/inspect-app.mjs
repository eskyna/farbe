...
function evaluateI18n(activeLanguage) {
  ...
  return {
    ...
    labels: {
      ...
      iosInstallApp: i18n.t('ui.iosInstallApp'),
      iosInstallTitle: i18n.t('ui.iosInstallTitle'),
      iosInstallIntroSafari: i18n.t('ui.iosInstallIntroSafari'),
      iosInstallIntroOther: i18n.t('ui.iosInstallIntroOther'),
      iosInstallStepAdd: i18n.t('ui.iosInstallStepAdd'),
