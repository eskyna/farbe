  ...
  const TRANSLATIONS = {
    de: {
      ui: {
        ...
        iosInstallApp: 'App installieren',
        iosInstallKicker: 'iPhone & iPad',
        iosInstallTitle: 'ESKYNA Farbe installieren',
        iosInstallIntroSafari: 'Tippe in Safari auf das Teilen-Symbol und füge diese Farbkarte zum Home-Bildschirm hinzu.',
        iosInstallIntroOther: 'Auf iPhone und iPad funktioniert die Installation über Safari. Kopiere den Link und öffne ihn in Safari.',
        iosInstallStepOpenSafari: 'Diese Farbkarte in Safari öffnen.',
        iosInstallStepShare: 'Unten oder oben auf das Teilen-Symbol tippen.',
        iosInstallStepAdd: '„Zum Home-Bildschirm hinzufügen“ wählen. Falls der Punkt fehlt: ganz nach unten scrollen, „Aktionen bearbeiten“ öffnen und aktivieren.',
        iosInstallStepConfirm: '„Hinzufügen“ bestätigen. Danach öffnet sich die Farbkarte wie eine App.',
        iosInstallSafariRequired: 'Hinweis: Chrome, Google-App und Instagram auf iOS können die App nicht direkt installieren. Bitte über Safari hinzufügen.',
        iosInstallCopy: 'Link kopieren',
        iosInstallDone: 'Verstanden',
        iosInstallClose: 'Installationshinweis schließen',
        iosInstallCopied: 'Link kopiert',
        iosInstallCopyFailed: 'Link bitte aus der Adresszeile kopieren',
    ...
    en: {
      ui: {
        ...
        iosInstallApp: 'Install app',
        iosInstallKicker: 'iPhone & iPad',
        iosInstallTitle: 'Install ESKYNA Color',
        iosInstallIntroSafari: 'In Safari, tap the Share icon and add this color card to your Home Screen.',
        iosInstallIntroOther: 'On iPhone and iPad, installation works through Safari. Copy the link and open it in Safari.',
        iosInstallStepOpenSafari: 'Open this color card in Safari.',
        iosInstallStepShare: 'Tap the Share icon at the bottom or top.',
        iosInstallStepAdd: 'Choose “Add to Home Screen”. If it is missing, scroll down, open “Edit Actions” and enable it.',
        iosInstallStepConfirm: 'Confirm with “Add”. The color card will then open like an app.',
        iosInstallSafariRequired: 'Note: Chrome, the Google app and Instagram on iOS cannot install the app directly. Please add it through Safari.',
        iosInstallCopy: 'Copy link',
        iosInstallDone: 'Got it',
        iosInstallClose: 'Close installation guide',
        iosInstallCopied: 'Link copied',
        iosInstallCopyFailed: 'Please copy the link from the address bar',
        updating: 'Updating ...',
    ...
    ru: {
      ui: {
        ...
        iosInstallApp: 'Установить приложение',
        iosInstallKicker: 'iPhone и iPad',
        iosInstallTitle: 'Установить ESKYNA Цвет',
        iosInstallIntroSafari: 'В Safari нажмите значок «Поделиться» и добавьте эту цветовую карту на экран «Домой».',
        iosInstallIntroOther: 'На iPhone и iPad установка работает через Safari. Скопируйте ссылку и откройте её в Safari.',
        iosInstallStepOpenSafari: 'Откройте эту цветовую карту в Safari.',
        iosInstallStepShare: 'Нажмите значок «Поделиться» внизу или вверху.',
        iosInstallStepAdd: 'Выберите «На экран Домой». Если пункта нет, прокрутите вниз, откройте «Изменить действия» и включите его.',
        iosInstallStepConfirm: 'Подтвердите «Добавить». После этого цветовая карта откроется как приложение.',
        iosInstallSafariRequired: 'Важно: Chrome, приложение Google и Instagram на iOS не могут установить приложение напрямую. Добавьте его через Safari.',
        iosInstallCopy: 'Скопировать ссылку',
        iosInstallDone: 'Понятно',
        iosInstallClose: 'Закрыть инструкцию по установке',
        iosInstallCopied: 'Ссылка скопирована',
        iosInstallCopyFailed: 'Скопируйте ссылку из адресной строки',
        updating: 'Обновление ...',
